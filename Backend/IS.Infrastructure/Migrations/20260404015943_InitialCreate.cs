        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldValue = table.Column<string>(type: "nvarchar(300)", nullable: true),
                    NewValue = table.Column<string>(type: "nvarchar(300)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatchNumber = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSuppliers_ProductId_SupplierId_BatchNumber",
                table: "ProductSuppliers",
                columns: new[] { "ProductId", "SupplierId", "BatchNumber" },
                unique: true);
